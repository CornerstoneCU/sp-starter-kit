    ...
    return (
      <div>
        {this.props.alerts.map(alert => <MessageBar
          messageBarType={alert.type === AlertType.Urgent ? MessageBarType.error : alert.type === AlertType.Resolved ? MessageBarType.success : alert.type === AlertType.News ? MessageBarType.info : MessageBarType.warning}
          isMultiline={false}
        >
          {alert.message}
